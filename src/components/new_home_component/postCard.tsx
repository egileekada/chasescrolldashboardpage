...
export default function PostCard(props: IMediaContent) {
    ...
    return (
        <Flex
            style={{
                borderBottom:
                    "0.5px solid var(--Miscellaneous-Tab---Unselected, #999999)",
            }}
            w={"full"}
        ...
        >
            <Flex w={"full"} gap={"3"} flexDir={"column"}>
                    ...
                    <Flex alignItems={"center"} gap={["1", "1", "1"]}>
                        ...
                        >
                            ...
                            >
                                ...
                                <Text fontSize={"14px"}>
                                    {textLimit(
                                        capitalizeFLetter(user?.firstName),
                                        20,
                                    )}
                                </Text>
                                <Text fontSize={"8px"} color={bodyTextColor}>
                            ...
                            <Flex
                                ...
                                textAlign={"left"}
                            >
                                <Text color={"#233DF3"} fontSize={"14px"}>
                                    {textLimit(
                                        capitalizeFLetter(user?.firstName) +
                                            " " +
                                            capitalizeFLetter(user?.lastName),
                                        15,
                                    )}
                                </Text>
                                <Text mt={"-4px"} fontSize={"10px"}>
                                    @{textLimit(user?.username, 12)}
                                </Text>
                                <Text fontSize={"8px"} color={bodyTextColor}>
                                    {moment(timeInMilliseconds).fromNow()}
                                </Text>
                ...
                >
                    ...
                    <Flex
                        ...
                        h={["26px", "26px", "30px"]}
                        alignItems={"center"}
                        onClick={() => clickHandleCommentMobile()}
                        w={"fit-content"}
                        gap={["3px", "2px", "2px"]}
                    >
                        <Flex
                ...
                <Flex px={"2"}>
                    ...
                    text?.includes("www.") ? (
                        ...
                        >
                            {capitalizeFLetter(textLimit(text, textSize))}{" "}
                            {text?.length > 100 && (
                                <span
                                    style={{
                                        color: primaryColor,
            ...
            <ModalLayout open={deleteModal} close={setDeleteModal} size={"xs"}>
                ...
                >
                    <Image
                        alt="delete"
                        src="/assets/images/deleteaccount.svg"
                    />
                    <CustomText textAlign={"center"} fontSize={"20px"}>
                        Delete Post
                    </CustomText>
                    <CustomText textAlign={"center"} fontSize={"16px"}>
            ...
            <ModalLayout
                size={["full", "full", "6xl"]}
                open={openComments}
                close={setOpenComments}
            >
                <CommentSection
                    close={setOpenComments}
                    count={count}
                    liked={liked}
                    likesHandle={clickHandleLike}
