                            ...
                            {item?.size?.length > 0 && (
                                <Flex w={"full"} flexDir={"column"} gap={"3"} >
                                    ...
                                    <Flex gap={"2"} flexWrap={"wrap"} >
                                        {item?.size?.map((item) => {
                                            return (
                                                <Flex key={item} w={"fit-content"} px={"3"} borderWidth={"1px"} cursor={"pointer"} borderColor={size === item ? primaryColor : borderColor} onClick={() => setSize((prev) => prev === item ? "" : item)} h={"10"} justifyContent={"center"} alignItems={"center"} rounded={"lg"} bgColor={size === item ? "#F2F4FF" : mainBackgroundColor} >
                                                    {item}
                                                </Flex>
                                            )
                                        })}
                            ...
                            {item?.color?.length > 0 &&
                                <Flex w={"full"} flexDir={"column"} gap={"3"} >
                                    ...
                                    <Flex gap={"2"} flexWrap={"wrap"} >
                                        {item?.color?.map((item) => {
                                            return (
                                                <Flex key={item?.label} w={"fit-content"} gap={"1"} px={"3"} borderWidth={"1px"} cursor={"pointer"} borderColor={color === item?.label ? primaryColor : borderColor} onClick={() => setColor((prev) => prev === item?.label ? "" : item?.label)} h={"10"} justifyContent={"center"} alignItems={"center"} rounded={"lg"} bgColor={color === item?.label ? "#F2F4FF" : mainBackgroundColor} >
